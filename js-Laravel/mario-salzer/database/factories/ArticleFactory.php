...
class ArticleFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        # nicht alle IDs scheinen valid -> https://picsum.photos/v2/list?page=2&limit=100
        $id = $this->get_lp_id(); # rand(1, 1000);

        return [
            "title" => $this->mk_title(),
            "desc" => join("</p><p>", fake()->paragraphs(rand(3, 11))),
            "img" => "https://picsum.photos/id/$id/780/500",
            "img_thumb" => "https://picsum.photos/id/$id/125/125",
            // Kategories müssen schon bestehen!!!!
            "catid" =>  DB::table("categories")->select("id")->inRandomOrder()->limit(1)->first()->id,
        ];
    }
    ...
    {
        $pre = [
            "verfluchte", "verfluchte", "verfluchte", "verfluchte", "verfluchte",  # <- primäres Schlagwort x5
            "verwunschene", "furchtbare", "verstrahlte", "grauenhafte", "schnöde",
            "irre", "ungeheuerliche", "verteufelte", "verdammte", "verhexte",
            "verzauberte", "verflixte", "üble", "unerwünschte", "ungünstige", "unbeliebte",
            "prekäre", "teuflische", "gräuliche", "grauenhafte", "abscheuliche",
        ];
        $art = [
            # passt nicht alles https://de.wikipedia.org/wiki/Erben_des_Fluchs
            "Uhr", "Vase", "Tür", "Pipette", "Katze", "Steingruppe", "LaravelDatei",
            "Schere", "Fußmatte", "Bluetooth-Maus", "Aufklebersammlung", "Vitrine", "Brotrinde",
            "ENDE-Taste", "Fabrik", "Tasse", "Maske", "Vogelscheuche", "Flasche",
            "Kerze", "Mitternachtshappen", "Schallplatte", "Zitrone", "Prophezeiung",
            "Batterie", "Abwaschbürste", "Kokosmilch", "Treppe", "Downloads",
        ];
